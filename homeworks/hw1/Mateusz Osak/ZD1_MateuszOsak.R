...
reviews <- read.csv("/Users/mateuszosak/Documents/ZadDom1twd/reviews.csv")
listings <- read.csv("/Users/mateuszosak/Documents/ZadDom1twd/listings.csv")
...
saveRDS(solutions, file = "MateuszOsak.rds")
